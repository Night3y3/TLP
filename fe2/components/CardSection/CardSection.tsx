...
export default class CardSection extends Component {
    render() {
        return (
            <div className='flex flex-col items-center bg-gray-100 mb-10 w-screen h-screen justify-center'>
                ...
                <div className='flex overflow-hidden'>
                    <ReviewCard name={Data[3].name} date={Data[3].date} photo={Data[3].photo} body={Data[3].body} />
                    <ReviewCard name={Data[4].name} date={Data[4].date} photo={Data[4].photo} body={Data[4].body} />
                    <ReviewCard name={Data[5].name} date={Data[5].date} photo={Data[5].photo} body={Data[5].body} />
